function calculate() {
    ...
    nudeln.innerHTML = `Nudeln: ${nudelnResult} g (ca. ${nudelnResult*125}g)`;
...
function calculateKnoblauch() {
    ...
    knoblauch.innerHTML = `Knoblauch: ${kuemmelResult} Zehe`;
}
...
function calculateCrèmefraîche() {
    ...
    crèmefraîche.innerHTML = `Crèmefraîche: ${kuemmelResult} EL`;
}
...
function calculateOlivenöl() {
    ...
    olivenöl.innerHTML = `Olivenöl: ${kuemmelResult} EL`;
}
